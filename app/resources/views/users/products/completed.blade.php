                ...
                @include('includes.accountNav')
                      ...
                      <a href="" class="btn btn-gray arrow btn-xs p-1"><< Back</a>
                       ...
                       <table class="table table-bordered" cellspacing="0">
                           ...
                           <span class="border-bottom border-color-1 mb-5" style="line-height:2">Payment Status: @if($orders->is_paid == 1) <button class="btn btn-success btn-xs p-0">&nbsp; Success &nbsp;</button>@else <button type="button" class="btn btn-warning btn-xs p-0">Pending</button>@endif</span><br>
                           <span class="border-bottom border-color-1 mb-5" style="line-height:2">Delivery Status:  @if($orders->is_delivered == 1) <button class="btn btn-success btn-xs p-0">&nbsp; Delivered &nbsp;</button>@else <button type="button" class="btn btn-warning btn-xs p-0">Pending Delivery</button> @endif</span><br>
                            </p>
