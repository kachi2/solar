                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                     ...
                                     <div class="col-md-6">
                                      ...
                                      <input type="text" name="name" placeholder="Slider Name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" >
                                            <small id="emailHelp" class="form-text text-muted">Enter Slider Name
                                            </small>
                                            @error('name')
